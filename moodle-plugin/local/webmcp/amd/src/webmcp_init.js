define(['core/ajax', 'core/notification'], function(ajax, notification) {
    ...
    return {
        init: function(config) {
            ...
            console.log('[Moodle WebMCP] Initializing W3C/Chrome WebMCP standard...');

            // Ensure document.modelContext exists (or provide compliant fallback)
            ...
            document.modelContext.registerTool({
                ...
                description: 'Get all active courses the logged-in student or instructor is enrolled in, with course codes and instructors.',
                inputSchema: {
                    type: 'object',
                    properties: {}
                },
            ...
            document.modelContext.registerTool({
                ...
                inputSchema: {
                    ...
                    properties: {
                        assignment_id: {
                            type: 'number',
                            description: 'The assignment ID to inspect.'
                        }
                    },
                            ...
                            criteria: [
                                {
                                    ...
                                    weight_points: 35,
                                    description: 'Depth, accuracy, and comparative analysis using Utilitarianism vs Deontology.'
                                },
                                {
                                    id: 'crit-technical-depth',
                                    title: 'Technical Depth & WebMCP Protocol',
                                    weight_points: 35,
                                    description: 'Factual understanding of tool calling, client-side DOM execution, and prompt injection mitigation.'
                                },
                                {
                                    id: 'crit-governance',
                                    title: 'Human-in-the-Loop Governance',
                                    weight_points: 20,
                                    description: 'Practicality and clarity of multi-tier confirmation boundaries.'
                                },
                                {
                                    id: 'crit-clarity',
                                    title: 'Clarity, Structure & Citations',
                                    weight_points: 10,
                                    description: 'Prose flow, logical hierarchy, and proper academic citations.'
                                }
                            ]
                        }
                    };
            ...
            // 6. Instructor Tools (if instructor/admin)
