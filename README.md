...
|---|---|---|---|
| **Live Moodle Server** | [https://moodle-webmcp.akashgpt.me](https://moodle-webmcp.akashgpt.me)<br>*(or [https://moodle-webmcp-9rzc.onrender.com](https://moodle-webmcp-9rzc.onrender.com))* | Real Moodle 4.5 LMS deployed on Render with `local_webmcp` baked in + persistent SQLite database. | **Admin / Instructor**:<br>User: `admin` / Pass: `MoodleWebMCP2026!`<br><br>**Student Account**:<br>User: `alex` (or `student1`) / Pass: `password123` |
...
- In the in-app browser, navigate to [https://moodle-webmcp.akashgpt.me](https://moodle-webmcp.akashgpt.me) (or [https://moodle-webmcp-9rzc.onrender.com](https://moodle-webmcp-9rzc.onrender.com)).
- Log in as student (`alex` / `password123`) or admin (`admin` / `MoodleWebMCP2026!`).
...
docker compose up -d
```
Open `http://localhost:8080` and log in with `admin` / `MoodleWebMCP2026!` or `alex` / `password123`.
